...
[design.background]
  ...
  # Background image.
  image = "infinity_and_eternity2.png"  # Name of image in `static/img/`.
...
{{% staticref "https://sites.google.com/view/kantsregulativeideas/home" "newtab" %}}Conference website{{% /staticref %}}
